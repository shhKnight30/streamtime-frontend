...
// import { useGetVideoCommentsQuery, useAddCommentMutation } from "@/store/services/commentApi";
...
//   const { data, isLoading, isError } = useGetVideoCommentsQuery(videoId);
...
//         contentType: 'video', // Specify content type as per backend API
//         contentId: videoId // Specify content ID as per backend API
//       }).unwrap();
//       reset(); // Clear input field on success
