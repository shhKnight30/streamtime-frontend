...
import { BarChart, Users, Eye, ThumbsUp, MessageSquare } from 'lucide-react';
...
export default function UserAnalyticsOverview() {
    ...
    // ← bgClass and textClass are now both passed and used correctly
    const StatCard = ({ title, value, icon: Icon, bgClass, textClass }) => (
        <Card className="p-6 flex items-center gap-4 bg-white dark:bg-zinc-900 border dark:border-zinc-800 rounded-xl shadow-sm">
            <div className={`p-4 rounded-full ${bgClass} bg-opacity-10 dark:bg-opacity-20`}>
